...
import stylesCss from 'themes/election/styles.css?inline';
...
import vaadinPasswordFieldCss from 'themes/election/components/vaadin-password-field.css?inline';
import vaadinTextAreaCss from 'themes/election/components/vaadin-text-area.css?inline';
import vaadinTextFieldCss from 'themes/election/components/vaadin-text-field.css?inline';
...
export const applyTheme = (target) => {
  ...
  if (!document['_vaadintheme_election_componentCss']) {
    registerStyles(
    ...
    document['_vaadintheme_election_componentCss'] = true;
  }
